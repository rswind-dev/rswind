...
mod variant {
    ...
    test_group! { variant =>
        ...
        composable_functional "has-aria-hidden" => "&:has(*[aria-hidden=\"true\"])",
        composable_functional_arb "has-aria-[sort=ascending]" => "&:has(*[aria-sort=ascending])",
        composable_functional_arb_modifier "has-group-hover/the-name" => "&:has(*:is(:where(.group\\/the-name):hover *))",
        composable_functional_arb_modifier_arb "has-group-hover/[the-name]" => "&:has(*:is(:where(.group\\/the-name):hover *))",
